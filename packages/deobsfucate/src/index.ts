...
function writeDeObs() {
    ...
    console.log('OutputLines', {
        clientLib: outputClientLib.length,
        qx: outputQx.length,
        gamedata: outputGameData.length,
    });
    ...
    fs.writeFileSync(`${OutputPath}/${currentDay}-gamedata.js`, outputGameData.join('\n'));
}
