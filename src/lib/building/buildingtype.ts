...
export class BuildingType extends GameDataObject {
    ...
    static GDI = {
        ...
        CrystalHarvester: new BuildingType(175, 'GDI_Harvester_Crystal', 'Crystal Harvester', 'n', [Tile.Crystal], ['s']),
        TiberiumHarvester: new BuildingType(115, 'GDI_Harvester', 'Tiberium Harvester', 'h', [Tile.Tiberium], ['s']),
    ...
    static NOD = {
        ...
        CrystalHarvester: new BuildingType(176, 'NOD_Harvester_Crystal', 'Crystal Harvester', 'n', [Tile.Crystal], ['s']),
        TiberiumHarvester: new BuildingType(155, 'NOD_Harvester', 'Tiberium Harvester', 'h', [Tile.Tiberium], ['s']),
